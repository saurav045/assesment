...
public class BlueMixVersion {
	...
	public String getBits_endpoint() {
		return bits_endpoint;
	}

	public void setBits_endpoint(String bits_endpoint) {
		this.bits_endpoint = bits_endpoint;
	}
